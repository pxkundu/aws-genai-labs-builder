# 🎯 Pre-Assessment Quiz - Discover Your Starting Point
...
**Answer: B) Computer systems that can perform tasks requiring human intelligence**

**Explanation:** AI refers to computer systems that can perform tasks that typically require human intelligence, such as learning, reasoning, and problem-solving.
...
**Answer: C) Machine Learning can learn and adapt, while traditional programming follows fixed rules**

**Explanation:** Traditional programming follows explicit instructions, while Machine Learning can learn patterns from data and improve over time.
...
**Answer: B) AI that creates new content like text, images, or music**

**Explanation:** Generative AI is a type of AI that can create new content, such as text, images, music, or code, based on patterns it has learned from training data.
...
**Answer: B) Using remote servers over the internet instead of local computers**

**Explanation:** Cloud computing means using remote servers accessed over the internet to store, manage, and process data instead of using local computers.
...
**Answer: B) A limited free usage of AWS services for new users**

**Explanation:** The AWS Free Tier provides limited free usage of many AWS services for new users, typically for 12 months.
...
**Answer: B) The ability to increase or decrease resources based on demand**

**Explanation:** Scalability in cloud computing refers to the ability to automatically adjust resources (like computing power or storage) based on current demand.

</details>

### **Section 3: Programming and Technical Basics (5 questions)**
...
**Answer: B) A general-purpose programming language used for many applications including AI**

**Explanation:** Python is a versatile programming language used for web development, data analysis, AI, machine learning, and many other applications.
...
**Explanation:** A library is a collection of pre-written code, functions, and modules that you can import and use in your programs to avoid writing everything from scratch.
...
**Answer: B) Version control for tracking changes in code**

**Explanation:** Git is a version control system that helps developers track changes in their code, collaborate with others, and manage different versions of their projects.
...
**Answer: B) A text-based interface for interacting with your computer**

**Explanation:** A terminal or command line is a text-based interface where you can type commands to interact with your computer's operating system.
...
**Answer: D) Making coffee in the morning**

**Explanation:** While AI is used in many applications, making coffee is typically done by humans or simple machines, not AI systems.
...
**Answer: B) To help analyze medical images and assist in diagnosis**

**Explanation:** Machine learning in healthcare is used to analyze medical images, assist in diagnosis, and help healthcare professionals make better decisions, but it doesn't replace doctors.
...
**Answer: B) A field of AI that helps computers understand human language**

**Explanation:** Natural Language Processing (NLP) is a field of AI that focuses on helping computers understand, interpret, and generate human language.
...
**Answer: B) A field of AI that helps computers understand and interpret visual information**
...
**Answer: B) To automate repetitive tasks and help make better decisions**

**Explanation:** AI in business is primarily used to automate repetitive tasks, analyze data, and help make better decisions, while working alongside humans rather than replacing them.
